...
emp_x= [['\'hi\'', '\'dude\'', '\'my street\'', '\'chicago\'' , '\'usa\'', '\'210-666\'', '\'scaryguygmail.com\'', 0.2, 1389],
         [1,'noval', 'noval', '\'next_street\'', '\'new york\'' , '\'usa\'', '\'210-666-0009\'', '\'scaryguy22gmail.com\'', 'noval', 1389],
         [2]   ]



cust_x = [
    ['\'john\'', '\'wick\'', '\'killer street\'', '\'london\'', '\'uk\'',
     '\'999-000\'', '\'wickgmail.com\'', '\'wolves\'', 12, 500.0, 1],

    [1,'noval', 'noval', '\'new address\'', '\'manchester\'', '\'uk\'',
     '\'999-111\'', '\'wick22gmail.com\'', 'noval', 'noval', 800.0, 'noval'],
...
disc_x = [
    ...
    [1,'noval', 100, 'noval', 25, 'noval'],

    [1]
]
item_x = [
    ['\'new ball\'', '\'pro ball\'', '\'red\'', '\'L\'',
     '\'equipment\'', 1, 25.0, 15.0, 30],

    [4,'noval', '\'updated desc\'', 'noval', 'noval',
     '\'clothing\'', 'noval', 30.0, 'noval', 50],
